...
* ![Medium][medium_img] <p dir="rtl" align="right"> يعني ان العنصر ينصح بشدة استخدامه، لكن يُمكن ان يهمل في بعض الحالات الخاصة، ولكن بعض العناصر إذا أُهملت يمكن ان تأثر على الأداء او SEO . </p>
* ![High][high_img] <p dir="rtl" align="right"> يعني ان العنصر لا يمكن إهماله لأي سبب، اذا تم اهمالة سيتسبب بمشاكل في الصفحة و SEO، أولوية اختبارات الاداء تكون على هذة العناصر اولاً. </p>
<p align="right">
:نوع المحتوى الذي ستجده في قائمة التدقيق
</p>
* 📖: <p dir="rtl" align="right"> توثيقات او مقالات </p>
</br>
* 🛠: <p dir="rtl" align="right"> ادوات اختبار </p>
</br>
* 📹: <p dir="rtl" align="right"> محتوى مرئي </p>
